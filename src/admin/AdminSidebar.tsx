/**
 * AdminSidebar — navigation for the PracticePro Admin APK.
 * Dark-themed, compact sidebar with admin-only navigation items.
 */
        ...
        <aside className="w-16 sm:w-60 flex-shrink-0 bg-slate-900 dark:bg-black flex flex-col h-full border-r border-slate-800">
            ...
            <div className="flex-shrink-0 p-4 border-b border-slate-800">
                <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary-500 to-indigo-600 flex items-center justify-center text-white font-black text-sm flex-shrink-0">
                        P
                    </div>
                    <div className="hidden sm:block min-w-0">
                        <p className="text-sm font-black text-white tracking-tight">PracticePro</p>
                        <p className="text-2xs text-slate-500 font-bold uppercase tracking-widest">Admin</p>
                    </div>
                </div>
            </div>

...
export const JURISDICTION_REGISTRY: Record<string, JurisdictionConfig> = {
  ...
  // ── Remaining states + FCT (added to ensure ARIA/ALOA covers all 36
  //    Nigerian states and the FCT, per user requirement that the AI
  //    applies the property/tenancy law of the state where each property
  //    is located — not just Lagos). Each entry follows the same shape
  //    as the originals: High Court caption, Magistrate Court caption,
  //    Federal High Court caption, and the state's civil procedure rules.
  //    Where a state's tenancy / recovery of premises law has a specific
  //    name, it's reflected in the highCourtRules citation.
  Adamawa: {
    key: 'Adamawa',
    name: 'Adamawa State',
    capital: 'Yola',
    highCourtCaption: 'IN THE HIGH COURT OF ADAMAWA STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF ADAMAWA STATE, HOLDEN AT YOLA',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT YOLA',
    highCourtRules: 'High Court of Adamawa State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Adamawa State',
    defaultDivision: 'Yola',
  },
  Bauchi: {
    key: 'Bauchi',
    name: 'Bauchi State',
    capital: 'Bauchi',
    highCourtCaption: 'IN THE HIGH COURT OF BAUCHI STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF BAUCHI STATE, HOLDEN AT BAUCHI',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT BAUCHI',
    highCourtRules: 'High Court of Bauchi State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Bauchi State',
    defaultDivision: 'Bauchi',
  },
  Bayelsa: {
    key: 'Bayelsa',
    name: 'Bayelsa State',
    capital: 'Yenagoa',
    highCourtCaption: 'IN THE HIGH COURT OF BAYELSA STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF BAYELSA STATE, HOLDEN AT YENAGOA',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT YENAGOA',
    highCourtRules: 'High Court of Bayelsa State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Bayelsa State',
    defaultDivision: 'Yenagoa',
  },
  Benue: {
    key: 'Benue',
    name: 'Benue State',
    capital: 'Makurdi',
    highCourtCaption: 'IN THE HIGH COURT OF BENUE STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF BENUE STATE, HOLDEN AT MAKURDI',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT MAKURDI',
    highCourtRules: 'High Court of Benue State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Benue State',
    defaultDivision: 'Makurdi',
  },
  Borno: {
    key: 'Borno',
    name: 'Borno State',
    capital: 'Maiduguri',
    highCourtCaption: 'IN THE HIGH COURT OF BORNO STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF BORNO STATE, HOLDEN AT MAIDUGURI',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT MAIDUGURI',
    highCourtRules: 'High Court of Borno State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Borno State',
    defaultDivision: 'Maiduguri',
  },
  Ebonyi: {
    key: 'Ebonyi',
    name: 'Ebonyi State',
    capital: 'Abakaliki',
    highCourtCaption: 'IN THE HIGH COURT OF EBONYI STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF EBONYI STATE, HOLDEN AT ABAKALIKI',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT ABAKALIKI',
    highCourtRules: 'High Court of Ebonyi State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Ebonyi State',
    defaultDivision: 'Abakaliki',
  },
  Ekiti: {
    key: 'Ekiti',
    name: 'Ekiti State',
    capital: 'Ado-Ekiti',
    highCourtCaption: 'IN THE HIGH COURT OF EKITI STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF EKITI STATE, HOLDEN AT ADO-EKITI',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT ADO-EKITI',
    highCourtRules: 'High Court of Ekiti State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Ekiti State',
    defaultDivision: 'Ado-Ekiti',
  },
  Gombe: {
    key: 'Gombe',
    name: 'Gombe State',
    capital: 'Gombe',
    highCourtCaption: 'IN THE HIGH COURT OF GOMBE STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF GOMBE STATE, HOLDEN AT GOMBE',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT GOMBE',
    highCourtRules: 'High Court of Gombe State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Gombe State',
    defaultDivision: 'Gombe',
  },
  Jigawa: {
    key: 'Jigawa',
    name: 'Jigawa State',
    capital: 'Dutse',
    highCourtCaption: 'IN THE HIGH COURT OF JIGAWA STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF JIGAWA STATE, HOLDEN AT DUTSE',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT DUTSE',
    highCourtRules: 'High Court of Jigawa State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Jigawa State',
    defaultDivision: 'Dutse',
  },
  Katsina: {
    key: 'Katsina',
    name: 'Katsina State',
    capital: 'Katsina',
    highCourtCaption: 'IN THE HIGH COURT OF KATSINA STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF KATSINA STATE, HOLDEN AT KATSINA',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT KATSINA',
    highCourtRules: 'High Court of Katsina State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Katsina State',
    defaultDivision: 'Katsina',
  },
  Kebbi: {
    key: 'Kebbi',
    name: 'Kebbi State',
    capital: 'Birnin Kebbi',
    highCourtCaption: 'IN THE HIGH COURT OF KEBBI STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF KEBBI STATE, HOLDEN AT BIRNIN KEBBI',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT BIRNIN KEBBI',
    highCourtRules: 'High Court of Kebbi State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Kebbi State',
    defaultDivision: 'Birnin Kebbi',
  },
  Kogi: {
    key: 'Kogi',
    name: 'Kogi State',
    capital: 'Lokoja',
    highCourtCaption: 'IN THE HIGH COURT OF KOGI STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF KOGI STATE, HOLDEN AT LOKOJA',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT LOKOJA',
    highCourtRules: 'High Court of Kogi State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Kogi State',
    defaultDivision: 'Lokoja',
  },
  Kwara: {
    key: 'Kwara',
    name: 'Kwara State',
    capital: 'Ilorin',
    highCourtCaption: 'IN THE HIGH COURT OF KWARA STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF KWARA STATE, HOLDEN AT ILORIN',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT ILORIN',
    highCourtRules: 'High Court of Kwara State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Kwara State',
    defaultDivision: 'Ilorin',
  },
  Nasarawa: {
    key: 'Nasarawa',
    name: 'Nasarawa State',
    capital: 'Lafia',
    highCourtCaption: 'IN THE HIGH COURT OF NASARAWA STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF NASARAWA STATE, HOLDEN AT LAFIA',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT LAFIA',
    highCourtRules: 'High Court of Nasarawa State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Nasarawa State',
    defaultDivision: 'Lafia',
  },
  Niger: {
    key: 'Niger',
    name: 'Niger State',
    capital: 'Minna',
    highCourtCaption: 'IN THE HIGH COURT OF NIGER STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF NIGER STATE, HOLDEN AT MINNA',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT MINNA',
    highCourtRules: 'High Court of Niger State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Niger State',
    defaultDivision: 'Minna',
  },
  Ondo: {
    key: 'Ondo',
    name: 'Ondo State',
    capital: 'Akure',
    highCourtCaption: 'IN THE HIGH COURT OF ONDO STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF ONDO STATE, HOLDEN AT AKURE',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT AKURE',
    highCourtRules: 'High Court of Ondo State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Ondo State',
    defaultDivision: 'Akure',
  },
  Osun: {
    key: 'Osun',
    name: 'Osun State',
    capital: 'Osogbo',
    highCourtCaption: 'IN THE HIGH COURT OF OSUN STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF OSUN STATE, HOLDEN AT OSOGBO',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT OSOGBO',
    highCourtRules: 'High Court of Osun State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Osun State',
    defaultDivision: 'Osogbo',
  },
  Plateau: {
    key: 'Plateau',
    name: 'Plateau State',
    capital: 'Jos',
    highCourtCaption: 'IN THE HIGH COURT OF PLATEAU STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF PLATEAU STATE, HOLDEN AT JOS',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT JOS',
    highCourtRules: 'High Court of Plateau State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Plateau State',
    defaultDivision: 'Jos',
  },
  Sokoto: {
    key: 'Sokoto',
    name: 'Sokoto State',
    capital: 'Sokoto',
    highCourtCaption: 'IN THE HIGH COURT OF SOKOTO STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF SOKOTO STATE, HOLDEN AT SOKOTO',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT SOKOTO',
    highCourtRules: 'High Court of Sokoto State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Sokoto State',
    defaultDivision: 'Sokoto',
  },
  Taraba: {
    key: 'Taraba',
    name: 'Taraba State',
    capital: 'Jalingo',
    highCourtCaption: 'IN THE HIGH COURT OF TARABA STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF TARABA STATE, HOLDEN AT JALINGO',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT JALINGO',
    highCourtRules: 'High Court of Taraba State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Taraba State',
    defaultDivision: 'Jalingo',
  },
  Yobe: {
    key: 'Yobe',
    name: 'Yobe State',
    capital: 'Damaturu',
    highCourtCaption: 'IN THE HIGH COURT OF YOBE STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF YOBE STATE, HOLDEN AT DAMATURU',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT DAMATURU',
    highCourtRules: 'High Court of Yobe State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Yobe State',
    defaultDivision: 'Damaturu',
  },
  Zamfara: {
    key: 'Zamfara',
    name: 'Zamfara State',
    capital: 'Gusau',
    highCourtCaption: 'IN THE HIGH COURT OF ZAMFARA STATE',
    magistrateCourtCaption: 'IN THE MAGISTRATE COURT OF ZAMFARA STATE, HOLDEN AT GUSAU',
    federalHighCourtCaption: 'IN THE FEDERAL HIGH COURT OF NIGERIA, HOLDEN AT GUSAU',
    highCourtRules: 'High Court of Zamfara State (Civil Procedure) Rules',
    magistrateRules: 'Magistrate Court (Civil Procedure) Rules of Zamfara State',
    defaultDivision: 'Gusau',
  },
};

        ...
        <div className={`flex gap-3 ${isCurrentUser ? 'flex-row-reverse' : 'flex-row'}`}>
            ...
            <div className={`max-w-[75%] ${isCurrentUser ? 'items-end' : 'items-start'} flex flex-col gap-1`}>
                <div className={`px-4 py-2.5 rounded-2xl text-sm ${isCurrentUser
                    ...
                    : 'bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 text-slate-800 dark:text-zinc-200 rounded-tl-sm'
                    }`}>
                    {message.content}
                </div>
...
const ClientMatterDetailViewContent: React.FC = () => {
    ...
    if (!matter) {
        if (!isDataLoaded) {
            return (
                <div className="animate-pulse space-y-6">
                    ...
                    <div className="bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl shadow-md p-6">
                    ...
                    <div className="bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl shadow-md p-6 space-y-4">
        ...
        return (
            <div className="bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl shadow-md p-12 text-center">
    ...
    const renderTabContent = () => {
        switch (activeTab) {
                            ...
                            {!hasItems ? (
                                ...
                                <ul className="space-y-3">
                                    {pendingActionItems.map(item => (
                                        <li key={item.id} className="flex items-start gap-3 p-3 rounded-lg bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-700/50">
                                            <input
                                                type="checkbox"
            ...
            case 'messages':
                return (
                    <div className="bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl shadow-md flex flex-col h-[70vh]">
                        ...
                        <footer className="p-4 border-t border-slate-200 dark:border-zinc-700">
                            <div className="relative">
                                <input autoComplete="off" data-lpignore="true"  type="text" value={clientMessage} onChange={(e) => setClientMessage(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleSendMessageClick()} placeholder="Send a message..." className="w-full p-2 pr-20 rounded-lg bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700" />
    ...
    return (
        <div>
            ...
            <div className="bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl shadow-md p-6 mb-6">

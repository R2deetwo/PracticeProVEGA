...
export const ClientIntakePortal: React.FC = () => {
    ...
    if (!lead && !isDataLoaded) return (
        <div className="h-full flex flex-col items-center justify-center p-8">
            <div className="w-full max-w-md bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl p-6 animate-pulse">
    ...
    if (!lead && isDataLoaded) return (
        <div className="h-full flex flex-col items-center justify-center text-slate-400 p-8">
            <div className="w-16 h-16 bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 rounded-full flex items-center justify-center mb-4">
    ...
    return (
        <div>
            <div className="bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl shadow-md p-6 mb-6 text-center">

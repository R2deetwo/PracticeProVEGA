...
const GenerationOverlay: React.FC<GenerationOverlayProps> = ({ label = 'Drafting document...' }) => {
  return (
    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm pointer-events-auto">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-slate-400 dark:text-zinc-500 mt-1">The AI is drafting your document. This usually takes 10-20 seconds.</p>
        </div>
      </div>
    </div>
  );

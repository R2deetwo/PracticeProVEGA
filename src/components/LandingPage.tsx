        ...
        <div className="container mx-auto px-6 py-24">
            ...
            <div className="text-center mb-16">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-lg max-w-xl mx-auto leading-relaxed">
                    {isVega 
                        ...
                        : 'From tenant screening to rent collection, PracticePro simplifies property management.'}
                </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-fr">
                {isVega ? (
                    <>
                        <BentoCard
                            ...
                            desc="Visualize your entire caseload with Kanban boards tailored for Litigation and Corporate practice. Never miss a hearing or deadline again."
                        ...
                        <BentoCard
                            ...
                            desc="Your AI assistant for drafting, summarising documents, and working with your matter files. Legal research tools are expanding over time."
                        ...
                        <BentoCard
                            ...
                            desc="Nigerian court rules, deadlines, and workflow guidance built into your practice — so stages and timelines stay on track."
                            accent="bg-amber-500 text-amber-600 dark:text-amber-400"
                        />
                        <BentoCard
                            icon={<DocumentIcon />}
                            title="Guided Matter Intake"
                            desc="Structured matter creation with procedural checks and a smooth handoff into document drafting with your case metadata pre-filled."
                    ...
                    <>
                        ...
                        <BentoCard
                            icon={<ScalesIcon />}
                            title="Rent Tracking & Receipts"
                            desc="Record rent payments, issue receipts, and sync collections to your revenue ledger and portfolio dashboard."
                            accent="bg-blue-500 text-blue-600 dark:text-blue-400"
                        />
                        <BentoCard
                            icon={<DocumentIcon />}
                            title="Lease Management"
                            desc="Track lease terms, expiry dates, and renewals with alerts so nothing slips through at portfolio scale."
                            accent="bg-purple-500 text-purple-600 dark:text-purple-400"
                        />
                        <BentoCard
                            icon={<ZapIcon />}
                            title="Maintenance Tracking"
                            desc="Track issues from report to resolution with assigned tasks for vendors and property managers."
                            accent="bg-amber-500 text-amber-600 dark:text-amber-400"
                        />
                    </>
                )}
                <BentoCard
                    ...
                    desc="Bank-grade encryption with role-based access control. Associates only see what they need to see."

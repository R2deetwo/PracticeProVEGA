                    ...
                    <div className="prose prose-slate max-w-none
                        ...
                        <section id="portal-section-4" className="mb-20">
                            ...
                            <div className="space-y-12">
                                ...
                                <p>4.4 <strong>Notification Delivery:</strong> PracticePro may send you notifications via email in connection with your Portal account, and your firm or property manager may choose to share information with you through their own messaging apps (such as WhatsApp) from their own accounts. You acknowledge that these notification channels are not controlled by PracticePro and delivery is not guaranteed.</p>
                            </div>
                        </section>

                ...
                <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start mb-1">
                        ...
                        <div className="flex items-center gap-1.5 flex-shrink-0">
                            ...
                            <button
                                onClick={onDelete}
                                className="opacity-100 md:opacity-0 md:group-hover:opacity-100 p-1 text-slate-300 hover:text-red-500 transition-opacity"
                            >
...
const PropertyManagerView: React.FC<PropertyManagerViewProps> = ({ contacts, onViewDetails, openModal, isCompact }) => {
    ...
    // SIMPLIFY FIX: the non-compact full-page branch (~170 lines) was dead
    // code — this component is only ever mounted with isCompact={true}
    // (App.tsx properties SplitMasterDetail sidebar). Deleted along with
    // its KPI cards, bulk bar and empty state, which could never render.
    return null;
};

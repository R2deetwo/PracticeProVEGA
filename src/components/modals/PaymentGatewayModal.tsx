        ...
        <div className="bg-slate-50 dark:bg-zinc-900 p-6 flex flex-col items-center justify-center min-h-[400px]">
            {step === 'instructions' && (
                <div className="w-full max-w-sm space-y-6 animate-fade-in">
                    ...
                    <div className="bg-white dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl p-5 space-y-4">
                        <p className="text-xs font-bold text-slate-500 dark:text-zinc-400 uppercase tracking-wider">Transfer to this account</p>
                        ...
                        <div className="flex items-center justify-between group">
                            ...
                            <button
                                ...
                                className="p-1.5 text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-lg transition-colors opacity-0 group-hover:opacity-100"
                                title="Copy"
                            >
                    ...
                    <button
                        ...
                        className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-300 disabled:dark:bg-zinc-700 disabled:text-slate-500 disabled:dark:text-zinc-500 text-white font-bold rounded-lg shadow-lg transition-all transform hover:scale-[1.02] disabled:hover:scale-100"
                    >
            ...
            {step === 'confirming' && (
                <div className="text-center animate-fade-in">
                    ...
                    <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-2">Recording Confirmation...</h3>
                    <p className="text-slate-500 dark:text-zinc-400">Your payment will be verified by the firm.</p>
                </div>
            )}

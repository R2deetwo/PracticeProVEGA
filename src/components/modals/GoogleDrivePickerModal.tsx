    ...
    return (
        <div className="flex flex-col h-full max-h-[60vh]">
            ...
            <div className="flex items-center gap-3 pb-4 border-b border-slate-200 dark:border-zinc-700">
                ...
                <h3 className="text-lg font-bold text-slate-700 dark:text-slate-200">Import from Google Drive</h3>
            </div>
            ...
            <div className="relative py-4">
                ...
                <input autoComplete="off" data-lpignore="true"
                    type="text"
                    className="w-full pl-10 pr-4 py-2.5 border border-slate-200 dark:border-zinc-700 rounded-xl bg-white dark:bg-zinc-800 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-shadow"
            ...
            <div className="flex-grow flex flex-col items-center justify-center py-12 text-center">
                ...
                <h4 className="text-base font-bold text-slate-700 dark:text-white mb-2">Google Drive Integration</h4>
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-zinc-700 flex justify-end">
                <button
                    onClick={onClose}
                    className="px-5 py-2 text-sm font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-zinc-800 rounded-xl transition-colors"
                >
                    Close
                </button>
            </div>

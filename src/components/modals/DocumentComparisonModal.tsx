...
export const DocumentComparisonModal: React.FC<DocumentComparisonModalProps> = ({ currentDocument, versionToCompare, onClose }) => {
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      ...
      <h4 className="text-lg font-bold text-slate-800 dark:text-zinc-100 mb-2">Version Comparison</h4>
      ...
      <div className="mt-6">
        <button
          onClick={onClose}
          className="px-6 py-2 bg-slate-200 text-slate-700 dark:text-zinc-300 rounded-xl font-bold hover:bg-slate-300 transition-colors"
        >
          Close
        </button>
      </div>

        ...
        <div className="space-y-6 pb-2">
            ...
            <div className="flex flex-col gap-1 border-b border-slate-100 dark:border-zinc-700/50 pb-4">
                 <div className="flex items-center gap-2 mb-1">
                    <span className={`px-2 py-0.5 text-2xs font-black uppercase tracking-widest rounded-md ${task.status === 'done' ? 'bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-400' : 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-400'}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-slate-50/50 dark:bg-zinc-800/20 p-4 rounded-2xl border border-slate-100 dark:border-zinc-700/30">
                 <div className="flex items-start gap-3">
                    ...
                    <div>
                       <p className="text-2xs font-black text-slate-400 dark:text-zinc-500 uppercase tracking-[0.2em] mb-0.5">DUE DATE</p>
                 ...
                 <div className="flex items-start gap-3">
                    ...
                    <div>
                       <p className="text-2xs font-black text-slate-400 dark:text-zinc-500 uppercase tracking-[0.2em] mb-0.5">TASK CATEGORY</p>
            ...
            {task.description && (
                <div className="space-y-2">
                    <p className="text-2xs font-black text-slate-400 dark:text-zinc-500 uppercase tracking-[0.2em] px-1">SPECIFICATIONS</p>
            ...
            <div className="space-y-3">
                <p className="text-2xs font-black text-slate-400 dark:text-zinc-500 uppercase tracking-[0.2em] px-1">ASSIGNED TEAM</p>
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-zinc-800 flex justify-between items-center gap-3">
                {canManage && (
                    <>
                        <button type="button" onClick={onDelete} className="px-6 py-2.5 bg-red-50 text-red-600 dark:bg-red-900/20 dark:text-red-400 rounded-xl font-black text-2xs uppercase tracking-widest hover:bg-red-600 hover:text-white transition-all shadow-sm flex items-center gap-2">

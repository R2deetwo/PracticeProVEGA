    ...
    return (
        <div className="p-1 sm:p-2 animate-fade-in">
            <div className="text-center mb-8">
                <div className="w-16 h-16 bg-primary-100 dark:bg-primary-900/30 rounded-2xl flex items-center justify-center mx-auto mb-4 scale-110 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div className="flex bg-slate-100 dark:bg-white/5 p-1 rounded-xl mb-4">
                    <button
                        ...
                        className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${selectedProduct === 'vega' ? 'bg-white dark:bg-slate-800 text-primary-600 shadow-sm' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}
                    >
                        Vega (Legal OS)
                    </button>
                    <button
                        ...
                        className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${selectedProduct === 'atrium' ? 'bg-white dark:bg-slate-800 text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}
                    >
                        Atrium (Property OS)
                    </button>
                </div>
                ...
                <div className="relative group">
                    ...
                    <input autoComplete="off" data-lpignore="true" 
                        ...
                        className="w-full pl-11 pr-4 py-4 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all outline-none text-slate-900 dark:text-white placeholder:text-slate-400"
                        required
                        autoFocus
                    />
                </div>

                <div className="bg-slate-100 dark:bg-white/5 p-4 rounded-xl border border-slate-200 dark:border-white/10 flex items-start gap-3">

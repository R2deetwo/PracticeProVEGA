          ...
          {verificationText && !requiresPassword && (
            <div className="p-4 bg-rose-50 dark:bg-rose-900/10 rounded-lg border border-rose-100 dark:border-rose-900/30">
              ...
              <input
                ...
                className="w-full p-2.5 text-sm border border-rose-300 dark:border-rose-800 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-rose-500 bg-white dark:bg-zinc-800 text-slate-900 dark:text-white"

...
const AloaHelpModal: React.FC = () => {
  ...
  return (
    <div className="space-y-6 text-sm text-slate-600 dark:text-zinc-400">
      ...
      <div>
        <h4 className="font-bold text-lg mb-2 text-slate-800 dark:text-zinc-100">What {assistantName}® Can Do</h4>
      ...
      <div>
        <h4 className="font-bold text-lg mb-2 text-slate-800 dark:text-zinc-100">How to Talk to {assistantName}®</h4>
        <p>Use natural language for your requests. Here are some examples:</p>
        <div className="mt-2 space-y-1 text-sm bg-slate-100 dark:bg-zinc-800 p-3 rounded-md">
      ...
      <div>
        <h4 className="font-bold text-lg mb-2 text-slate-800 dark:text-zinc-100">Privacy & Data</h4>

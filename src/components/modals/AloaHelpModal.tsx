  ...
  return (
    <div className="space-y-6 text-sm text-slate-600">
      <div className="text-center">
        ...
        <h3 className="text-2xl font-bold mt-2 text-slate-900">{assistantName}®: {isProperty ? 'Your AI Assistant' : 'Your AI Paralegal'}</h3>
      ...
      <div>
        <h4 className="font-bold text-lg mb-2 text-slate-800">What {assistantName}® Can Do</h4>
      ...
      <div>
        <h4 className="font-bold text-lg mb-2 text-slate-800">How to Talk to {assistantName}®</h4>
        <p>Use natural language for your requests. Here are some examples:</p>
        <div className="mt-2 space-y-1 text-sm bg-slate-100 p-3 rounded-md">
      ...
      <div>
        <h4 className="font-bold text-lg mb-2 text-slate-800">Privacy & Data</h4>

...
const AloaHelpModal: React.FC = () => {
    ...
    const handleTryDemo = () => {
        closeModal();
        // A small delay to ensure the modal is closed before opening ALOA
        setTimeout(() => {
            togglePanel();
        }, 300);
    };
    ...
    return (
        <div className="space-y-6 text-sm text-slate-600 dark:text-zinc-300">
            <div className="text-center">
                ...
                <h3 className="text-2xl font-bold mt-2 text-slate-900 dark:text-white">ALOA®: Your AI Paralegal</h3>
                <p className="mt-1">ALOA® is designed to be your proactive legal assistant, helping you manage your practice more efficiently.</p>
            </div>

            <div>
                <h4 className="font-bold text-lg mb-2 text-slate-800 dark:text-white">What ALOA® Can Do</h4>
                <ul className="space-y-2">
                    <li className="flex gap-3"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-500 flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg><span><strong>Summarize legal documents</strong> to get the key points instantly.</span></li>
                    <li className="flex gap-3"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-500 flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg><span><strong>Find deadlines</strong> based on Nigerian court rules.</span></li>
            ...
            <div>
                <h4 className="font-bold text-lg mb-2 text-slate-800 dark:text-white">How to Talk to ALOA®</h4>
                ...
                <div className="mt-2 space-y-1 text-sm bg-slate-100 dark:bg-zinc-700/50 p-3 rounded-md">
                    <p className="font-mono">"Go to my matters"</p>
                    <p className="font-mono">"What are my overdue tasks?"</p>
                    <p className="font-mono">"Create a new task to file response by Tuesday"</p>
                </div>
            </div>
            
            <div>
                <h4 className="font-bold text-lg mb-2 text-slate-800 dark:text-white">Privacy & Data</h4>
                <p>ALOA® processes your text commands via Google Gemini's secure API. Your prompts are used to provide responses but are not stored to train the model. PracticePro never stores private client data within the AI's memory.</p>
            </div>

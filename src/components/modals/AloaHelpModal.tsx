    ...
    return (
        <div className="space-y-6 text-sm text-slate-600 dark:text-zinc-300">
            <div className="text-center">
                ...
                <p className="mt-1">{isProperty ? 'ARIA® is designed to be your proactive property assistant' : 'ARIA® is designed to be your proactive legal assistant'}, helping you manage your {isProperty ? 'operations' : 'practice'} more efficiently.</p>
            </div>

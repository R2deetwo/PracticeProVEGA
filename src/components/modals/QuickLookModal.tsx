        ...
        return (
            <div className="flex flex-col items-center justify-center py-12 px-6 text-center space-y-4">
                <div className="w-14 h-14 rounded-2xl bg-slate-100 dark:bg-zinc-800 flex items-center justify-center">
                    <MattersIcon className="w-6 h-6 text-slate-400 dark:text-zinc-500" />
                </div>
                <div className="space-y-1">
                    <h3 className="text-base font-bold text-slate-700 dark:text-white tracking-tight">No item selected.</h3>
                    <p className="text-xs text-slate-500 dark:text-zinc-400">Close this window and try again.</p>
                </div>
                <button
                    onClick={() => closeModal()}

    ...
    return (
        <div className="flex flex-col gap-0 p-3">
            ...
            <NavItem
                ...
                icon={
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                }
                isActive={false}
                onClick={() => openModalFromUI('feedback')}
                onCloseDrawer={onCloseDrawer}
            />
        </div>
    );
...
export const SettingsView: React.FC = () => {
    ...
    return (
        <div className="h-[100dvh] flex flex-col bg-slate-50 dark:bg-zinc-950 overflow-hidden">
            ...
            <header className="sticky top-0 pt-safe z-30 flex-shrink-0 glass border-b border-slate-200 dark:border-zinc-800">

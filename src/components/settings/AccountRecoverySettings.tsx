            ...
            <div className="p-5 bg-white dark:bg-zinc-800 rounded-2xl border border-slate-200 dark:border-zinc-700 shadow-sm space-y-5">
                <div className="relative">
                    ...
                    <input autoComplete="off" data-lpignore="true" 
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm dark:text-white transition-all"
                    />
                </div>
                ...
                {users !== undefined && users.length > 0 && (
                    <div className="space-y-3">
                        {users.map((user: any) => (
                            <div key={user._id} className="flex flex-col sm:flex-row gap-4 p-4 border border-slate-200 dark:border-zinc-700 rounded-lg bg-slate-50 dark:bg-zinc-900/50 hover:border-indigo-300 transition-colors">

...
const WorkflowForm: React.FC<WorkflowFormProps> = ({
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 -m-2">
            ...
            <div className="sticky bottom-0 left-0 right-0 pt-8 bg-white dark:bg-zinc-900 border-t border-slate-100 dark:border-zinc-800 flex flex-wrap sm:justify-between items-center gap-4 z-50">
                <div>
                    {isEditing && onDelete && (
                ...
                <div className="flex flex-wrap-reverse sm:justify-end gap-3 flex-1 sm:flex-none">
                    ...
                    <button
                        ...
                        className="flex-1 sm:flex-none px-12 py-2.5 bg-primary-600 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl shadow-2xl shadow-primary-500/30 hover:bg-primary-700 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                    >

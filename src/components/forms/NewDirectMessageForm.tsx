...
const NewDirectMessageForm: React.FC<NewDirectMessageFormProps> = ({ users, onClose, initialContext }) => {
    ...
    const commonInputClass = "text-gray-900 dark:text-gray-300 w-full bg-gray-50 dark:bg-zinc-800/50 dark:bg-zinc-700 border border-gray-300 dark:border-zinc-600 rounded-md shadow-sm p-2 focus:ring-primary-500 focus:border-primary-500";
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="flex p-1 bg-slate-100 dark:bg-zinc-800 rounded-lg">
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-2 text-sm font-semibold rounded-md transition-all ${mode === 'direct'
                        ? 'bg-white dark:bg-zinc-900 dark:bg-zinc-700 shadow text-primary-600 dark:text-primary-300 dark:text-primary-400'
            ...
            <div className="pt-4 flex justify-end items-center space-x-2 border-t border-slate-100 dark:border-zinc-800">
                <button type="button" onClick={onClose} className="px-4 py-2 bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 text-slate-700 dark:text-slate-200 rounded-lg font-semibold hover:bg-slate-200 dark:hover:bg-zinc-700 dark:hover:bg-zinc-600 transition-colors">Cancel</button>

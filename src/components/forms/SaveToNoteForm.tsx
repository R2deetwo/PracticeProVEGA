                        ...
                        <div className="grid grid-cols-3 items-center">
                            ...
                            <div className="flex justify-center">
                                <button
                                    ...
                                    className={`w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center transition-all duration-300 transform active:scale-95 shadow-sm relative ${isRecording ? 'bg-red-500 text-white ring-4 ring-red-500/20' : 'bg-slate-900 dark:bg-white dark:bg-zinc-900 text-white dark:text-slate-950 hover:scale-105'}`}
                                >

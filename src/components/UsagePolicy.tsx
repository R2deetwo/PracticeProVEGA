...
const UsagePolicy: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    return (
        <div className="w-full h-full bg-white flex flex-col overflow-hidden animate-fade-in font-sans">
            ...
            <div className="flex-1 overflow-y-auto scroll-smooth custom-scrollbar">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 py-10 lg:py-16">

                    <div className="mb-12">
                        <h1 className="font-display text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Usage Policy</h1>
                    ...
                    <div className="prose prose-slate max-w-none prose-p:leading-[1.8] prose-p:mb-8 prose-h2:mt-12 prose-h2:mb-6 prose-h2:text-2xl prose-h2:font-bold prose-h2:border-b-2 prose-h2:pb-3 prose-h2:border-slate-200 prose-h3:mt-8 prose-h3:mb-4 prose-h3:text-lg prose-h3:font-bold prose-ul:mb-6 prose-ul:space-y-2 prose-li:leading-relaxed">
                        ...
                        <p>
                            ...
                            Email: <a href="mailto:practiceprovega@gmail.com" className="text-primary-600 underline">practiceprovega@gmail.com</a><br />

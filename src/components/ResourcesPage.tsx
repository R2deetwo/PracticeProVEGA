...
const WHATS_NEW_ENTRIES: WhatsNewEntry[] = [
    ...
    },
    {
        ...
        category: 'feature',
        items: [
            { label: 'Court Date Reminders', body: 'WhatsApp reminders scheduled 7, 3, and 1 day(s) before each scheduled hearing to assigned lawyers. Requires WhatsApp integration setup.', badge: 'Growth+' },

...
const FilterPanel: React.FC<{
    ...
    return (
        <div className="h-full flex flex-col p-4 space-y-6 overflow-y-auto bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-900 border-r border-slate-200 dark:border-zinc-800">
            <div>
                ...
                <div className="space-y-2">
                    {courts.map(court => (
                        <label key={court} className="flex items-center gap-2 cursor-pointer group">
                            <div className={`w-4 h-4 flex-shrink-0 border rounded flex items-center justify-center transition-colors ${activeCourts.has(court) ? 'bg-primary-600 border-primary-600' : 'bg-white dark:bg-zinc-900 dark:bg-zinc-800 border-slate-300 dark:border-zinc-600 group-hover:border-primary-500'}`}>
            ...
            <div>
                ...
                <input autoComplete="off" data-lpignore="true"  
                    ...
                    className="w-full px-3 py-2 bg-white dark:bg-zinc-900 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 transition-shadow"
                />
            </div>
            ...
            <div>
                ...
                <div className="flex gap-2">
                    <input autoComplete="off" data-lpignore="true"  
                        ...
                        className="w-full px-2 py-1 bg-white dark:bg-zinc-900 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded text-sm text-center"
                    />
                ...
                return (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 mb-2 text-xs text-slate-500 dark:text-zinc-400">
                             <span className="font-mono bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 px-1.5 py-0.5 rounded">{c.citation}</span>
                             <span>•</span>
                        ...
                        <div className="flex flex-wrap gap-1 mt-2">
                            {c.tags?.slice(0, 3).map(tag => (
                                <span key={tag} className="text-2xs px-1.5 py-0.5 bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 text-slate-500 dark:text-zinc-400 rounded-full">{tag}</span>
                            ))}
                        </div>
                    </div>
                );
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {caseData.referencedStatutes.map(s => (
                                            <span key={s} className="px-2 py-0.5 bg-white dark:bg-zinc-900 dark:bg-zinc-700 border border-slate-200 dark:border-zinc-600 rounded text-xs font-mono text-slate-600 dark:text-zinc-300">{s}</span>
                                        ))}
                                    </div>
                                </div>
                            )}
                        ...
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-3 border-b border-slate-200 dark:border-zinc-700 pb-2">Judgment</h3>
                         <div className="prose prose-slate dark:prose-invert max-w-none text-justify leading-7 font-serif">
                            {caseData.fullText ? (
                                ...
                                <div className="p-8 text-center bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-800 rounded-lg border border-dashed border-slate-300 dark:border-zinc-700 text-slate-500">
            ...
            <div className="flex-grow flex overflow-hidden relative w-full">
                ...
                <div className={`${mobileView === 'detail' ? 'flex w-full' : 'hidden'} md:flex flex-1 min-w-0 bg-white dark:bg-zinc-900`}>
                    {selectedCase ? (
                        ...
                        <div className="flex-grow hidden md:flex flex-col items-center justify-center text-slate-400 bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-900/50 w-full h-full">
                            <div className="flex flex-col items-center">
                                <div className="p-6 bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-full shadow-sm mb-4">

    ...
    <div className={`relative flex flex-col sm:flex-row sm:items-center gap-3 px-4 py-3.5 border rounded-xl transition-all ${
      ...
      <div className="flex items-center justify-between sm:justify-end gap-4 border-t border-slate-800 sm:border-0 pt-3 sm:pt-0">
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          <button onClick={onSendWhatsApp} title="Send WhatsApp" className="p-2.5 sm:p-2 text-slate-500 hover:text-green-400 hover:bg-slate-800 rounded-lg transition-colors">
            <MessageIcon className="w-5 h-5" />
          </button>
          {charge.isDefaulter && !charge.penaltyApplied && (
            <button onClick={onPenalty} title="Apply Late Penalty" className="p-2.5 sm:p-2 text-slate-500 hover:text-rose-400 hover:bg-slate-800 rounded-lg transition-colors">
              <ZapIcon className="w-5 h-5" />
            </button>
          )}
          {isCritical && (
            <button onClick={onRestrict} title="Restrict Access" className="p-2.5 sm:p-2 text-slate-500 hover:text-rose-400 hover:bg-slate-800 rounded-lg transition-colors">

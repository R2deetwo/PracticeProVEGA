...
export const CommunicationPrintView: React.FC<CommunicationPrintViewProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-slate-950/90 backdrop-blur-sm flex items-center justify-center print:bg-white dark:bg-zinc-900 print:backdrop-blur-none">
      ...
      >
        ...
        {/* Recipient Info */}
        <div className="px-8 py-4 print:px-12 print:py-6 bg-slate-50 dark:bg-zinc-800/50 border-b border-slate-200">
                ...
                <div key={comm._id} className="print-comm-entry relative flex gap-4 pb-6 print:pb-8">
                  ...
                  <div className="flex-1 min-w-0 pb-2">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      <span className="text-2xs font-bold text-slate-400 uppercase tracking-wider px-1.5 py-0.5 rounded bg-slate-100 dark:bg-zinc-800 print:bg-slate-50 dark:bg-zinc-800/50">
        ...
        {/* Footer */}
        <div className="px-8 py-4 print:px-12 print:py-6 border-t border-slate-200 bg-slate-50 dark:bg-zinc-800/50">

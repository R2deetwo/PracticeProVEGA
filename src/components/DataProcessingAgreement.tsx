                                ...
                                <table className="w-full text-sm border-collapse">
                                    ...
                                    <tbody>
                                        {[
                                            ...
                                            // Note: Google Gemini API is NOT listed as a sub-processor because
                                            // each firm supplies its own API key and contracts directly with Google.
                                            // See Privacy Policy §5.1 for details.

        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col h-full">
                    <div className="flex justify-between items-center mb-3">
                        <h4 className="font-bold text-slate-800 dark:text-white flex items-center gap-2">
                            Time Entries
                            <span className="bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 text-slate-600 dark:text-zinc-300 text-xs px-2 py-0.5 rounded-full">{timeEntries.length}</span>
                        </h4>
                    </div>
                    <div className="flex-grow bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl border border-slate-200 dark:border-zinc-700 overflow-hidden flex flex-col shadow-sm min-h-[300px]">
                        {timeEntries.length > 0 ? (
                            <div className="max-h-96 overflow-y-auto p-2 space-y-2 custom-scrollbar">
                                {timeEntries.map(entry => (
                                    <div key={entry.id} className="p-3 rounded-lg bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-700/30 border border-slate-100 dark:border-zinc-700/50 group hover:border-primary-200 dark:hover:border-primary-800 transition-colors">
                                        ...
                                        <div className="flex justify-between items-end">
                                            ...
                                            <div className="opacity-0 group-hover:opacity-100 flex gap-1 transition-opacity">
                                                <Tooltip text="Edit"><button onClick={() => openModal('editTimeEntry', entry.id)} className="p-1.5 rounded bg-white dark:bg-zinc-900 dark:bg-zinc-600 hover:bg-primary-50 dark:hover:bg-primary-900/50 text-slate-400 hover:text-primary-600 transition-colors"><EditIcon className="w-3.5 h-3.5" /></button></Tooltip>
                                                <Tooltip text="Delete"><button onClick={(e) => handleDeleteTime(e, entry)} className="p-1.5 rounded bg-white dark:bg-zinc-900 dark:bg-zinc-600 hover:bg-red-50 dark:hover:bg-red-900/50 text-slate-400 hover:text-red-600 transition-colors"><TrashIcon className="w-3.5 h-3.5" /></button></Tooltip>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="flex flex-col items-center justify-center h-full p-6 text-center">
                                <div className="w-12 h-12 bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 rounded-full flex items-center justify-center mb-3">
                ...
                <div className="flex flex-col h-full">
                    <div className="flex justify-between items-center mb-3">
                        <h4 className="font-bold text-slate-800 dark:text-white flex items-center gap-2">
                            Expenses
                            <span className="bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 text-slate-600 dark:text-zinc-300 text-xs px-2 py-0.5 rounded-full">{expenses.length}</span>
                        </h4>
                    </div>
                    <div className="flex-grow bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl border border-slate-200 dark:border-zinc-700 overflow-hidden flex flex-col shadow-sm min-h-[300px]">
                        {expenses.length > 0 ? (
                            <div className="max-h-96 overflow-y-auto p-2 space-y-2 custom-scrollbar">
                                {expenses.map(expense => (
                                    <div key={expense.id} className="p-3 rounded-lg bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-700/30 border border-slate-100 dark:border-zinc-700/50 group hover:border-primary-200 dark:hover:border-primary-800 transition-colors">
                                        <div className="flex justify-between items-start mb-1">
                                        ...
                                        <div className="flex justify-between items-end">
                                            ...
                                            <div className="opacity-0 group-hover:opacity-100 flex gap-1 transition-opacity">
                                                <Tooltip text="Edit"><button onClick={() => openModal('editExpense', expense.id)} className="p-1.5 rounded bg-white dark:bg-zinc-900 dark:bg-zinc-600 hover:bg-primary-50 dark:hover:bg-primary-900/50 text-slate-400 hover:text-primary-600 transition-colors"><EditIcon className="w-3.5 h-3.5" /></button></Tooltip>
                                                <Tooltip text="Delete"><button onClick={(e) => handleDeleteExpenseClick(e, expense)} className="p-1.5 rounded bg-white dark:bg-zinc-900 dark:bg-zinc-600 hover:bg-red-50 dark:hover:bg-red-900/50 text-slate-400 hover:text-red-600 transition-colors"><TrashIcon className="w-3.5 h-3.5" /></button></Tooltip>
                                            </div>
                                        </div>
                                    </div>
                                ))}
            ...
            <div className="flex flex-col">
                <div className="flex justify-between items-center mb-3">
                    <h4 className="font-bold text-slate-800 dark:text-white flex items-center gap-2">
                        Invoices
                        <span className="bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 text-slate-600 dark:text-zinc-300 text-xs px-2 py-0.5 rounded-full">{matterInvoices.length}</span>
                    </h4>
                </div>
                <div className="bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl border border-slate-200 dark:border-zinc-700 overflow-hidden shadow-sm">
                    {matterInvoices.length > 0 ? (
                        <div className="max-h-80 overflow-y-auto p-2 space-y-2 custom-scrollbar">
                            {matterInvoices.map(invoice => (
                                <div key={invoice.id} onClick={() => navigateTo('invoiceDetail', invoice.id)} className="p-3 rounded-lg bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-700/30 border border-slate-100 dark:border-zinc-700/50 cursor-pointer hover:bg-slate-100 dark:hover:bg-zinc-700 transition-all group flex items-center justify-between">
                                    <div>
                        ...
                        <div className="flex flex-col items-center justify-center h-40 p-4 text-center">
                            <div className="w-10 h-10 bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 rounded-full flex items-center justify-center mb-3">

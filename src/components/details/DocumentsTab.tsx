...
export const DocumentsTab: React.FC<DocumentsTabProps> = ({
    ...
    const containerClasses = isEmbedded
        ? "bg-transparent"
        : "bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-xl shadow-md p-6";
        ...
        return (
            <div
                ...
                className={`
                    ...
                    bg-white dark:bg-zinc-900 dark:bg-zinc-800 hover:shadow-xl hover:-translate-y-1
            ...
            >
                ...
                <div className="flex-grow flex items-center justify-center py-4">
                    <div className="w-12 h-12 bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-700 rounded-2xl flex items-center justify-center text-slate-400 dark:text-zinc-400 group-hover:bg-primary-50 dark:group-hover:bg-primary-900/20 group-hover:text-primary-600 transition-all duration-300 shadow-sm group-hover:shadow-md">
                ...
                <div className="absolute inset-0 bg-black/5 dark:bg-black/30 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-1.5 backdrop-blur-[1px]">
                    <button onClick={(e) => { e.stopPropagation(); onViewDocumentDetails(doc.id); }} className="p-1.5 bg-white dark:bg-zinc-900 dark:bg-zinc-700 rounded-full text-slate-600 dark:text-slate-200 shadow-sm hover:scale-110 transition-transform">
                        <EyeIcon className="w-3 h-3" />
                    </button>
                    {doc.file && (
                        <button onClick={(e) => handleDownload(e, doc)} className="p-1.5 bg-white dark:bg-zinc-900 dark:bg-zinc-700 rounded-full text-slate-600 dark:text-slate-200 shadow-sm hover:scale-110 transition-transform">
        ...
        >
            ...
            {editorChoiceDoc && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-fade-in" onClick={() => setEditorChoiceDoc(null)}>
                    <div className="bg-white dark:bg-zinc-900 dark:bg-zinc-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-scale-up border border-slate-200 dark:border-zinc-700" onClick={e => e.stopPropagation()}>
                        <div className="p-6 text-center">
                            <div className="w-16 h-16 bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 rounded-2xl flex items-center justify-center mx-auto mb-4 text-slate-900 dark:text-white">
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                ...
                                >
                                    <div className="bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-600 p-2 rounded-lg text-slate-600 dark:text-slate-300">
                        ...
                        <div className="p-4 bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-900/50 border-t border-slate-100 dark:border-zinc-700 flex justify-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        {!hideUploadButton && (
                            <button
                                ...
                                className="px-3 py-1.5 bg-slate-100 dark:bg-zinc-800 dark:bg-zinc-700 text-slate-700 dark:text-zinc-200 border border-slate-200 dark:border-zinc-600 rounded-lg font-semibold text-xs hover:bg-slate-200 dark:hover:bg-zinc-600 flex items-center transition-colors"
                            >
            ...
            <div>
                {sharedDocuments.length > 0 ? (
                    ...
                    <div className={`text-center py-8 text-slate-500 dark:text-zinc-400 ${isEmbedded ? 'border-2 border-dashed border-slate-200 dark:border-zinc-700 rounded-xl' : 'bg-slate-50 dark:bg-zinc-800/50 dark:bg-zinc-900/50 rounded-lg border border-dashed border-slate-200 dark:border-zinc-700'}`}>

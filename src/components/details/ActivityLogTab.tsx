                        ...
                        <div key={activity.id} className="flex-shrink-0 w-64 snap-start relative">
                            ...
                            <div className="relative z-10 flex flex-col gap-2">
                                <div className="flex items-center gap-2">
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-2xs font-bold shadow-sm border-2 border-white dark:border-zinc-800 ${isSystem ? 'bg-primary-100 text-primary-700 dark:bg-primary-900/50 dark:text-primary-300' : 'bg-primary-100 text-primary-700 dark:bg-primary-900/50 dark:text-primary-300'}`}>

...
export const TasksView: React.FC = () => {
    ...
    return (
        <div ref={containerRef} className="flex flex-col h-full overflow-hidden bg-slate-50 dark:bg-zinc-900">
            <div className="sticky top-0 pt-safe z-30 glass flex-shrink-0 py-2.5 px-4 sm:px-6 lg:px-8 shadow-sm border-b border-slate-200 dark:border-zinc-700 flex flex-col sm:flex-row sm:items-center justify-between gap-4">

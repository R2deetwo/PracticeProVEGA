...
const TaskColumn: React.FC<{
    ...
    return (
        <div className={`flex flex-col min-w-[280px] max-w-[320px] flex-shrink-0 h-full rounded-lg bg-slate-100/50 dark:bg-zinc-800/50 border border-slate-200 dark:border-zinc-700/50 snap-center transition-all duration-500 ${isPulsing ? 'ring-2 ring-primary-400 ring-offset-2 ring-offset-transparent scale-[1.02] shadow-lg' : ''}`}>
            {/* Column Header */}

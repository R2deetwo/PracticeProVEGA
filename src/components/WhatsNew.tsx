...
export const CHANGELOG: ChangelogEntry[] = [
    {
        ...
        version: '1.18.0',
        date: '2026-07-18',
        title: 'New PDF Viewer, Full-Screen Preview & Mobile Upgrades',
        description: 'Documents get a complete preview overhaul with a faster, sharper PDF viewer. Plus a new full-screen reading mode, bidirectional note links, and better mobile touch targets.',
        features: [
            { icon: 'document', label: 'Faster, Sharper PDF Viewer', text: 'PDFs now render with the same engine used by Chrome and Firefox. Pages fit-to-viewport by default, zoom cleanly up to 300%, and text stays crisp at every size — on iPhone, Android, and desktop.' },
            { icon: 'document', label: 'Full-Screen Preview + Reading Mode', text: 'Click "Full Screen" on any document to open an immersive reader. Press R for Reading Mode — pure page view with no toolbar, dark background, ESC to exit. Bottom thumbnail strip for quick page jumps.' },
            { icon: 'pen', label: 'DraftPro: Note Links', text: 'Type [[Matter Name]] or [[Document Name]] in any note to create a backlink. The Endorsements tab now surfaces every note that mentions the current matter or document — no more lost context.' },
            { icon: 'shield', label: 'Komplete: Both Products, Everywhere', text: 'Komplete firms now see legal AND property features in every screen — calendar shows rent due dates AND court deadlines, contacts show Owners, Residents, and Legal Clients, Compose picks the right audience automatically.' },
            { icon: 'bolt', label: 'Mobile Touch Upgrades', text: 'Bigger touch targets across forms, thumb-reachable DraftPro ribbon buttons, and the document list menu now works on every screen size. Form footers wrap properly on narrow phones.' },
        ],
    },
    {
        id: 'v1.17.0',
    ...
    },
    {
        ...
        version: '1.12.0',
        date: '2026-04-03',
        title: 'Stronger Foundation & Universal Ingestion',
        description: 'PracticePro now has a more secure foundation, with platform administration separated from your firm data. We have also unified our AI document pipeline.',
        features: [
            { icon: 'shield', label: 'Domain Separation', text: 'Firm and User data are now kept separate from platform administration, for stronger security and a faster main app.' },
    ...
    },
    {
        ...
        description: 'PracticePro now has a more powerful Procedural Intelligence engine. Court rules, statutes, and case law are now stored directly in your firm\'s database for fast, bandwidth-efficient research.',
        features: [
            { icon: 'shield', label: 'Unified Legal Repository', text: 'All legal modules (Lagos HC Rules, FHC Rules, NWLR) are now hosted natively in your firm\'s database. Faster lookups and significantly lower data usage.' },

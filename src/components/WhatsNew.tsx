...
export const CHANGELOG: ChangelogEntry[] = [
    {
        ...
        version: '1.18.0',
        date: '2026-07-18',
        title: 'Professional PDF Viewer, Full-Screen Preview & Pre-Launch Audit',
        ...
        features: [
            { icon: 'document', label: 'Professional PDF Viewer', text: 'Replaced the old <object> tag with a pdf.js-powered viewer (same engine as Chrome/Firefox built-in PDF viewers). Canvas-based rendering gives exact fit-to-page math, proper page breaks, and works on iOS Safari, Android Chrome, and desktop.' },
            { icon: 'document', label: 'Full-Screen Preview + Reading Mode', text: 'Click the dark "Full Screen" button on any document to open an immersive reader. Press R for Reading Mode — pure page view with no toolbar, dark background, ESC to exit. Bottom thumbnail strip for quick page jumps.' },

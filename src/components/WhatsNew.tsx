...
export const CHANGELOG: ChangelogEntry[] = [
    ...
    },
    {
        ...
        description: 'ALOA is stepping out of the library and into the office. She now understands your entire firm\'s schedule and can assist with team availability, tasks, and scheduling.',
        features: [
            { icon: 'calendar', label: 'Top-Level Scheduling Intelligence', text: 'ALOA now has a 14-day chronological radar. Ask "Who is free next week?" and she will cross-reference your team\'s calendar and provide availability insights.' },

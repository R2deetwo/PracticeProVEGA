...
export const CHANGELOG: ChangelogEntry[] = [
    ...
    },
    {
        ...
        features: [
            ...
            { icon: 'calendar', label: 'Court Date Reminders (Pro)', text: 'Vega Pro firms get automatic reminders 7, 3, and 1 days before every court date by email and in-app notification. Built with a duplicate-prevention guard so rescheduled matters never spam you. Visible on the matter card and in the calendar module.', productScope: 'vega' },
    ...
    },
    {
        ...
        features: [
            ...
            { icon: 'portal', label: 'Visitor Management System', text: 'Gated estate residents generate 6-digit visitor access codes. Gatekeepers verify at the gate with a lightweight interface. Codes can be shared straight to WhatsApp, with offline fallback and grace periods.' },
    ...
    },
    {
        ...
        version: '1.10.0',
        date: '2026-03-24',
        title: 'ALOA: Your Administrative Assistant',
        ...
        features: [
            { icon: 'calendar', label: 'Top-Level Scheduling Intelligence', text: 'ALOA now has a 14-day chronological radar. Ask "Who is free next week?" and it will cross-reference your team\'s calendar and provide availability insights.' },
            { icon: 'bolt', label: 'Instant Task Delegation', text: 'Ask ALOA to schedule a meeting with a client or delegate a task to a team member based on their schedule, and it will immediately prep the required workflow forms for you.' },
            { icon: 'brain', label: 'Contextual Matter Awareness', text: 'When you talk to ALOA while viewing a Matter Dashboard, it automatically pulls in all relevant pending tasks, events, and documents to give you hyper-specific insights without you having to ask.' },
        ],
    },
    {
        id: 'v1.9.0',
        ...
        description: 'ALOA and the Note Taker are now seamlessly synced. Experience a smooth transition between legal research and memo drafting, tailored for premium mobile use.',
        features: [

...
export const VEGA_TIERS: Record<TierId, TierDef> = {
  ...
  Growth: {
    ...
    features: buildVegaFeatures({
      ...
      extras: [
        ...
        'Court Date Reminders — WhatsApp alerts 7/3/1 days before hearings (requires WhatsApp integration)',
      ],
    }),
    maxUsers: 5,
    maxUnits: null,
  ...
  Enterprise: {
    ...
    features: ['Unlimited users', 'Unlimited matters', 'Custom court document archives', 'Court Date Reminders — WhatsApp alerts 7/3/1 days before hearings (requires WhatsApp integration)', 'Contact sales for onboarding'],
    maxUsers: null,
    maxUnits: null,
    maxManagedProperties: null,
    maxActiveTenants: null,

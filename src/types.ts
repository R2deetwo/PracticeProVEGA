...
// Enums
export enum UserRole { Admin = 'Admin', Lawyer = 'Lawyer', Paralegal = 'Paralegal', Client = 'Client', ExternalCounsel = 'External Counsel', Pending = 'Pending' }

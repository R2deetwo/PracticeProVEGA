...
export interface Notification { id: string; firmId: string; userId: string; message: string; link: { view: View; id: string | null; context?: any; }; timestamp: number | string; isRead: boolean; }

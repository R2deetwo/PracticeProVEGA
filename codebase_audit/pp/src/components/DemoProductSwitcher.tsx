                        ...
                        <div className="p-3 space-y-2">
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    <p className={`text-sm font-bold ${currentProduct === 'vega' ? 'text-indigo-700 dark:text-indigo-400' : 'text-slate-800 dark:text-white'}`}>Vega Legal OS</p>
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    <p className={`text-sm font-bold ${currentProduct === 'atrium' ? 'text-emerald-700 dark:text-emerald-400' : 'text-slate-800 dark:text-white'}`}>Atrium Property OS</p>

...
export const MatterForm: React.FC<MatterFormProps> = (props) => {
            ...
            if (isEditing && matterToEdit) {
                ...
                if (linkedPropertyId) {
                    ...
                    if (prop && prop.matterId !== matterToEdit.id) {
                         dataHandlers.updateItem('properties', { id: linkedPropertyId, matterId: matterToEdit.id }, 'Property Link');
                    }
                }
                ...
                if (newMatter && linkedPropertyId) {
                    dataHandlers.updateItem('properties', { id: linkedPropertyId, matterId: newMatter.id }, 'Property Link');
                }
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col h-full bg-slate-50 dark:bg-zinc-900">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            <input autoComplete="off" data-lpignore="true"  
                                ...
                                className={`${commonInputClass} text-lg font-bold py-2 ${isLitigation && titleAutoGenerated ? 'bg-slate-100 dark:bg-zinc-800 text-slate-500 italic' : ''}`} 
            ...
            {/* ACTION FOOTER */}
            <div className="sticky bottom-0 left-0 right-0 p-4 sm:p-4 bg-white dark:bg-zinc-900 border-t border-slate-200 dark:border-zinc-800 flex flex-wrap-reverse sm:justify-end gap-3 z-20">

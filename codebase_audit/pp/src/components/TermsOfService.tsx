                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none 
                            ...
                            <div className="space-y-16">
                                <div id="1-1" className="space-y-8">
                                    ...
                                    <div className="space-y-8 pl-4 border-l-2 border-slate-100 dark:border-zinc-800">
                                        <p><strong>"ALOA"</strong> or <strong>"ALOA™"</strong> means Advanced Office Assistant, the artificial intelligence agent powered by Google's Gemini API that provides conversational interfaces, research assistance, document drafting, voice control, and proactive intelligence features within the Platform.</p>
                                        <p><strong>"AI Agents"</strong> means collectively, ALOA™, Jurisdiction Scout, ALDIA, DraftPro, Court Rules Agent, Privacy Shield Agent, and Scale Expert Agent, all of which constitute the artificial intelligence-powered components of the Platform.</p>
                        ...
                        <section id="section-8" className="mb-20">
                            ...
                            <div className="space-y-12">
                                ...
                                <p>8.3 <strong>Technical and Organisational Measures:</strong> We implement appropriate technical and organizational security measures to protect personal data against unauthorized access, accidental loss, destruction, or disclosure. These include SHA-256 password hashing, firm-level data isolation, encrypted transmission (TLS), and role-based access control.</p>
                        ...
                        <section id="section-10" className="mb-20">
                            ...
                            <div className="space-y-12">
                                ...
                                <p>10.2 <strong>Password Hashing:</strong> Passwords are never stored in plaintext. All passwords are irreversibly hashed using SHA-256 cryptographic hashing with a platform-specific salt before being stored in the database. This means that even in the event of an unauthorized database disclosure, your plaintext password cannot be recovered.</p>

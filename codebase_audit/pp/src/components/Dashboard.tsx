...
const Dashboard: React.FC = () => {
    ...
    const propertyRevenue = safeProperties.reduce((total, p) => {
        const rentDue = (p.rentPaymentHistory || [])
            .filter(rp => rp.status === 'overdue' || rp.status === 'pending')
            ...
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6 animate-fade-in">
                ...
                <div className="mb-6 flex-shrink-0">
                    <StatsWidget
                        ...
                        propertyRevenue={isDowngradedState ? 0 : propertyRevenue}

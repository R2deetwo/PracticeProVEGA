...
const RecordRentPaymentModalWrapper: React.FC<{ modalContext: any; closeModal: () => void }> = ({ modalContext, closeModal }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            await addEntry({ firmId, unitId, amount: parseFloat(amount), type: 'rent', status, channel: 'Bank Transfer', description: `Rent payment${tenantName ? ' from ' + tenantName : ''}`, paymentRef: '' });

            ...
            <div className="p-1 sm:p-4">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-zinc-400 font-medium">Updating <span className="text-primary-600 font-bold">{propertyIds.length}</span> selected properties.</p>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="space-y-3">
                            ...
                            <select 
                                ...
                                className="w-full bg-slate-50 dark:bg-zinc-900/50 border-2 border-slate-100 dark:border-zinc-800 rounded-2xl px-4 py-3 text-sm font-bold text-slate-700 dark:text-zinc-200 focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 outline-none transition-all"
                            >
                    ...
                    <div className="p-4 bg-amber-50 dark:bg-amber-900/10 rounded-2xl border border-amber-100 dark:border-amber-900/30 flex items-start gap-4">

        ...
        <div className="flex flex-col h-full max-h-[80vh]">
            ...
            <div className="relative mb-4">
                ...
                <input autoComplete="off" data-lpignore="true" 
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 outline-none"
                />
            </div>
                    ...
                    filteredContacts.map(contact => (
                        <button
                            ...
                            className={`w-full text-left p-4 rounded-xl border transition-all flex items-center justify-between group ${
                                ...
                                : 'border-slate-100 dark:border-zinc-800 hover:border-slate-300 dark:hover:border-zinc-700 hover:bg-slate-50 dark:hover:bg-zinc-800/50'
                            }`}
                        >
                            <div className="flex items-center gap-3">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${
                                    selectedTargetId === contact.id ? 'bg-primary-100 text-primary-600' : 'bg-slate-100 dark:bg-zinc-700 text-slate-500'
                                }`}>
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 dark:border-zinc-800 flex justify-end gap-3">
                <button 
                    onClick={onClose}
                    className="px-6 py-2 text-sm font-bold text-slate-500 hover:text-slate-700 dark:hover:text-zinc-300"
                >
                    Cancel
                </button>
                <button 

  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex p-1 bg-slate-200 dark:bg-zinc-900 rounded-lg">
        <button onClick={() => setActiveTab('type')} className={`w-1/2 py-1.5 text-sm font-semibold rounded-md ${activeTab === 'type' ? 'bg-white dark:bg-zinc-700 shadow' : ''}`}>Type Signature</button>
        <button onClick={() => setActiveTab('draw')} className={`w-1/2 py-1.5 text-sm font-semibold rounded-md ${activeTab === 'draw' ? 'bg-white dark:bg-zinc-700 shadow' : ''}`}>Draw Signature</button>
      </div>

      <div className="relative border border-gray-300 dark:border-gray-600 rounded-lg bg-slate-50 dark:bg-zinc-700/50 min-h-[12rem]">
        {activeTab === 'type' ? (
          ...
          <>
            ...
            <button onClick={clearCanvas} className="absolute top-2 right-2 px-2 py-1 text-xs bg-slate-200 dark:bg-zinc-600 rounded-md">Clear</button>
          </>
        )}
      </div>

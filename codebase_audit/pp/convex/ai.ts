...
export const generateContent = action({
  ...
  handler: async (ctx, args) => {
    ...
    // The demo key will be securely kept on the server.
    ...
    const apiKey = args.firmGeminiApiKey || envKey || fallbackDemoKey;
...
`.trim();
    ...
    const apiKey = process.env.GEMINI_API_KEY || process.env.GEMINI_DEMO_KEY || 'AIzaSyDd5ib2A1562gO2PY1FQElSVzwyIaeBAN8';
